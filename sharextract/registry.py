...
ADAPTER_REGISTRY: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "platform": "threads",
        "kind": "social_post",
        "provenance": "standard_open_graph_plus_tokenless_meta_oembed",
        "built_in": True,
        "priority": 38,
        "stability": "documented",
        "expected_methods": ["standard_open_graph_threads_post"],
        "fixture_ids": ["threads-post-contract"],
        "verification": {
            "last_verified_at": "2026-09-06",
            "mode": "unit+live",
        },
        "live_sample": {
            "url": "https://www.threads.com/@threads/post/DWjTI0cgH5O/",
            "platform": "threads",
            "methods": ["standard_open_graph_threads_post"],
        },
    },
    {
        "name": "instagram-post",
        ...
        "priority": 39,
        "stability": "documented",
        "expected_methods": ["standard_open_graph_instagram_post"],
        "fixture_ids": ["instagram-post-contract"],
        "verification": {
            "last_verified_at": "2026-09-06",
            "mode": "unit+live",
        },
        "live_sample": {
            ...
            "platform": "instagram",
            "methods": ["standard_open_graph_instagram_post"],
        },
    },
    {
        "name": "facebook-post",
        ...
        "priority": 40,
        "stability": "documented",
        "expected_methods": ["standard_open_graph_facebook_post"],
        "fixture_ids": ["facebook-post-contract"],
        "verification": {
            "last_verified_at": "2026-09-06",
            "mode": "unit+live",
        },
        "live_sample": {
            "url": "https://www.facebook.com/kevinloveofficial/posts/pfbid0nWhZeiMVjzLHVjzR6QngXeVug8Nw4YxncbbZrquMu72r3HM8a73k55keRWiaWNLTl/",
            "platform": "facebook",
            "methods": ["standard_open_graph_facebook_post"],
        },
    },
    {
        "name": "linkedin-post",
